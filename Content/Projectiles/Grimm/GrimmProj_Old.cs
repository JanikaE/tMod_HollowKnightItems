...
namespace HollowKnightItems.Content.Projectiles.Grimm
{
     ...
     */
    [Autoload(false)]
    internal class GrimmProj_Old : ModProjectile
    {
    ...
    [Autoload(false)]
    internal class GrimmThorn_Old : GrimmProj_Old
    {
        public override void SetStaticDefaults()
        {
    ...
    [Autoload(false)]
    internal class GrimmFirebird_Old : GrimmProj_Old
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
    ...
    [Autoload(false)]
    internal class GrimmFireball_Old : GrimmProj_Old
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
    ...
    [Autoload(false)]
    internal class GrimmShoot_Old : GrimmProj_Old
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
    ...
    [Autoload(false)]
    internal class GrimmShoot_Sides_Old : GrimmShoot_Old
    {
        public override void AI()
        {
            base.AI();
    ...
    [Autoload(false)]
    internal class GrimmShoot_Below_Old : GrimmShoot_Old
    {
        public override void AI()
        {
            base.AI();
